...
const saudiArabiaNeighbours = ["Qatar", "UAE", "Oman"]
...
const myCountry = {
    ...
    describe: function () {
        return console.log(`${this.country} has ${this.population} million ${this.language}-speaking people, ${this.neighbours.length} neighbours and a capital called ${this.capital}.`)
    },
